  ...
  <tr>
    <td class="product-col">
      <div class="text-center">
        <figure>
          <a :href="urlShowProduct" target="_blank" v-if="getUrlProductImage(productImage)">
    ...
    <td class="price-col">{{ cartProduct.product.price }} Руб</td>
    ...
    <td class="total-col">{{ productPrice }} Руб</td>
    <td class="remove-col">
      <a
        href="#"
        class="btn-remove"
